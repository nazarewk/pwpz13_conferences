...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Conference.publications_submission_period'
        db.alter_column(u'conferences_conference', 'publications_submission_period_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['conferences.TimePeriod']))
        # Adding unique constraint on 'Conference', fields ['publications_submission_period']
        db.create_unique(u'conferences_conference', ['publications_submission_period_id'])


        # Changing field 'Conference.duration'
        db.alter_column(u'conferences_conference', 'duration_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['conferences.TimePeriod']))
        # Adding unique constraint on 'Conference', fields ['duration']
        db.create_unique(u'conferences_conference', ['duration_id'])


        # Changing field 'Conference.summaries_submission_period'
        db.alter_column(u'conferences_conference', 'summaries_submission_period_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['conferences.TimePeriod']))
        # Adding unique constraint on 'Conference', fields ['summaries_submission_period']
        db.create_unique(u'conferences_conference', ['summaries_submission_period_id'])


        # Changing field 'Payment.time_to_pay'
        db.alter_column(u'conferences_payment', 'time_to_pay_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['conferences.TimePeriod']))
        # Adding unique constraint on 'Payment', fields ['time_to_pay']
        db.create_unique(u'conferences_payment', ['time_to_pay_id'])


        # Changing field 'Lecture.duration'
        db.alter_column(u'conferences_lecture', 'duration_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['conferences.TimePeriod']))
        # Adding unique constraint on 'Lecture', fields ['duration']
        db.create_unique(u'conferences_lecture', ['duration_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Lecture', fields ['duration']
        db.delete_unique(u'conferences_lecture', ['duration_id'])

        # Removing unique constraint on 'Payment', fields ['time_to_pay']
        db.delete_unique(u'conferences_payment', ['time_to_pay_id'])

        # Removing unique constraint on 'Conference', fields ['summaries_submission_period']
        db.delete_unique(u'conferences_conference', ['summaries_submission_period_id'])

        # Removing unique constraint on 'Conference', fields ['duration']
        db.delete_unique(u'conferences_conference', ['duration_id'])

        # Removing unique constraint on 'Conference', fields ['publications_submission_period']
        db.delete_unique(u'conferences_conference', ['publications_submission_period_id'])


        # Changing field 'Conference.publications_submission_period'
        db.alter_column(u'conferences_conference', 'publications_submission_period_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conferences.TimePeriod']))

        # Changing field 'Conference.duration'
        db.alter_column(u'conferences_conference', 'duration_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conferences.TimePeriod']))

        # Changing field 'Conference.summaries_submission_period'
        db.alter_column(u'conferences_conference', 'summaries_submission_period_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conferences.TimePeriod']))

        # Changing field 'Payment.time_to_pay'
        db.alter_column(u'conferences_payment', 'time_to_pay_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conferences.TimePeriod']))

        # Changing field 'Lecture.duration'
        db.alter_column(u'conferences_lecture', 'duration_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['conferences.TimePeriod']))
    ...
    models = {
        ...
        u'conferences.conference': {
            ...
            'duration': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'conference_duration'", 'unique': 'True', 'to': u"orm['conferences.TimePeriod']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'publications_submission_period': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'publications_submission'", 'unique': 'True', 'to': u"orm['conferences.TimePeriod']"}),
            ...
            'summaries_submission_period': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'summaries_submission'", 'unique': 'True', 'to': u"orm['conferences.TimePeriod']"})
        },
        ...
        u'conferences.review': {
            ...
            'unguessable_id': ('django.db.models.fields.CharField', [], {'default': "u'oc0UniLKtOoI6dWD2c88pZOFbHJwmnns'", 'unique': 'True', 'max_length': '32'})
        },
