...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Review.accepted'
        db.delete_column(u'conferences_review', 'accepted')

        # Adding field 'Review.status'
        db.add_column(u'conferences_review', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'NO', max_length=2),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Review.accepted'
        raise RuntimeError("Cannot reverse this migration. 'Review.accepted' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Review.accepted'
        db.add_column(u'conferences_review', 'accepted',
                      self.gf('django.db.models.fields.BooleanField')(),
                      keep_default=False)

        # Deleting field 'Review.status'
        db.delete_column(u'conferences_review', 'status')
    ...
    models = {
        ...
        u'conferences.review': {
            ...
            'unguessable_id': ('django.db.models.fields.CharField', [], {'default': "u'qOuNB7d5uUt5CrSHmPxUkfpuvmiWtfy6'", 'unique': 'True', 'max_length': '32'})
        },
        ...
        u'conferences.topic': {
            ...
            'conference': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['conferences.Conference']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
