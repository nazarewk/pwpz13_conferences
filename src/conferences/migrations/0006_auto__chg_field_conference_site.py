...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Conference.site'
        db.alter_column(u'conferences_conference', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sites.Site'], unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Conference.site'
        raise RuntimeError("Cannot reverse this migration. 'Conference.site' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Conference.site'
        db.alter_column(u'conferences_conference', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sites.Site'], unique=True))
    ...
    models = {
        ...
        u'conferences.review': {
            ...
            'unguessable_id': ('django.db.models.fields.CharField', [], {'default': "u'rQbHKHKqzjVA6dCCAvmNVplb9FA86JNr'", 'unique': 'True', 'max_length': '32'})
        },
