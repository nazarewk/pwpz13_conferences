...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Balance.user'
        db.alter_column(u'conferences_balance', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Balance', fields ['user']
        db.create_unique(u'conferences_balance', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Balance', fields ['user']
        db.delete_unique(u'conferences_balance', ['user_id'])


        # Changing field 'Balance.user'
        db.alter_column(u'conferences_balance', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'conferences.review': {
            ...
            'unguessable_id': ('django.db.models.fields.CharField', [], {'default': "u'VKpZYF17mtz2hDDWn6IH6noRIvlefvTU'", 'unique': 'True', 'max_length': '32'})
        },
