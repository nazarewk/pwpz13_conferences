...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reviewer.user_account'
        db.alter_column(u'conferences_reviewer', 'user_account_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True))
        # Adding unique constraint on 'Reviewer', fields ['user_account']
        db.create_unique(u'conferences_reviewer', ['user_account_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Reviewer', fields ['user_account']
        db.delete_unique(u'conferences_reviewer', ['user_account_id'])


        # Changing field 'Reviewer.user_account'
        db.alter_column(u'conferences_reviewer', 'user_account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        u'conferences.review': {
            ...
            'unguessable_id': ('django.db.models.fields.CharField', [], {'default': "u'iCrwtMIimniFLzngaa7hUeZMsu14SQRR'", 'unique': 'True', 'max_length': '32'})
        },
