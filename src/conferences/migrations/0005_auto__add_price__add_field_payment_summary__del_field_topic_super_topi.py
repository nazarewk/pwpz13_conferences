...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Price'
        db.create_table(u'conferences_price', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('conference', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'pricing', to=orm['conferences.Conference'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('value', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3)),
        ))
        db.send_create_signal(u'conferences', ['Price'])

        # Adding field 'Payment.summary'
        db.add_column(u'conferences_payment', 'summary',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name=u'payment', unique=True, null=True, to=orm['conferences.Summary']),
                      keep_default=False)

        # Deleting field 'Topic.super_topic'
        db.delete_column(u'conferences_topic', 'super_topic_id')

        # Adding field 'Topic.parent'
        db.add_column(u'conferences_topic', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'children', null=True, to=orm['conferences.Topic']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Price'
        db.delete_table(u'conferences_price')

        # Deleting field 'Payment.summary'
        db.delete_column(u'conferences_payment', 'summary_id')

        # Adding field 'Topic.super_topic'
        db.add_column(u'conferences_topic', 'super_topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'sub_topics', null=True, to=orm['conferences.Topic'], blank=True),
                      keep_default=False)

        # Deleting field 'Topic.parent'
        db.delete_column(u'conferences_topic', 'parent_id')
    ...
    models = {
        ...
        u'conferences.review': {
            ...
            'unguessable_id': ('django.db.models.fields.CharField', [], {'default': "u'OjR6Tf6fe8UXEcGn1M0B9IMyWrDarZ9R'", 'unique': 'True', 'max_length': '32'})
        },
