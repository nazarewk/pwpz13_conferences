...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConferencesFile.author'
        db.delete_column(u'conferences_conferencesfile', 'author_id')

        # Deleting field 'ConferencesFile.file'
        db.delete_column(u'conferences_conferencesfile', 'file_id')

        # Deleting field 'ConferencesFile.id'
        db.delete_column(u'conferences_conferencesfile', u'id')

        # Deleting field 'ConferencesFile.extra_info'
        db.delete_column(u'conferences_conferencesfile', 'extra_info')

        # Adding field 'ConferencesFile.file_ptr'
        db.add_column(u'conferences_conferencesfile', u'file_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['filer.File'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ConferencesFile.author'
        raise RuntimeError("Cannot reverse this migration. 'ConferencesFile.author' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ConferencesFile.author'
        db.add_column(u'conferences_conferencesfile', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ConferencesFile.file'
        raise RuntimeError("Cannot reverse this migration. 'ConferencesFile.file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ConferencesFile.file'
        db.add_column(u'conferences_conferencesfile', 'file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ConferencesFile.id'
        raise RuntimeError("Cannot reverse this migration. 'ConferencesFile.id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ConferencesFile.id'
        db.add_column(u'conferences_conferencesfile', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ConferencesFile.extra_info'
        raise RuntimeError("Cannot reverse this migration. 'ConferencesFile.extra_info' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ConferencesFile.extra_info'
        db.add_column(u'conferences_conferencesfile', 'extra_info',
                      self.gf('django.db.models.fields.CharField')(max_length=128),
                      keep_default=False)

        # Deleting field 'ConferencesFile.file_ptr'
        db.delete_column(u'conferences_conferencesfile', u'file_ptr_id')
    ...
    models = {
        ...
        u'conferences.review': {
            ...
            'unguessable_id': ('django.db.models.fields.CharField', [], {'default': "u'ItOPw3bw1jNRqymnPIqYxUDcjl0wihJg'", 'unique': 'True', 'max_length': '32'})
        },
