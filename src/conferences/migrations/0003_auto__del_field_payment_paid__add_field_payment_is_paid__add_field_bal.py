...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field registered_users on 'Conference'
        m2m_table_name = db.shorten_name(u'conferences_conference_registered_users')
        ...
        db.delete_column(u'conferences_payment', 'paid')

        # Adding field 'Payment.is_paid'
        db.add_column(u'conferences_payment', 'is_paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Balance.available'
        db.add_column(u'conferences_balance', 'available',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3),
                      keep_default=False)

        # Adding M2M table for field registered_users on 'Session'
        m2m_table_name = db.shorten_name(u'conferences_session_registered_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        # Removing M2M table for field registered_users on 'Conference'
        db.delete_table(db.shorten_name(u'conferences_conference_registered_users'))

        # Adding field 'Payment.paid'
        db.add_column(u'conferences_payment', 'paid',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3),
                      keep_default=False)

        # Deleting field 'Payment.is_paid'
        db.delete_column(u'conferences_payment', 'is_paid')

        # Deleting field 'Balance.available'
        db.delete_column(u'conferences_balance', 'available')

        # Removing M2M table for field registered_users on 'Session'
        db.delete_table(db.shorten_name(u'conferences_session_registered_users'))
    ...
    models = {
        ...
        u'conferences.balance': {
            ...
            'available': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'conferences.review': {
            ...
            'unguessable_id': ('django.db.models.fields.CharField', [], {'default': "u't2cyhjBa4IH8n36AMmBofUOt3xI3qH5N'", 'unique': 'True', 'max_length': '32'})
        },
